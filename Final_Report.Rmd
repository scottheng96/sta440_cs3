...
Sensitivity analysis was again conducted by changing the prior for $\mu_0$ in the model. We tried increasing and decreasing the variance of $\mu_0$, but had no impact on our prediction. We still got estimated probabilities of 0%. 

We also plotted the beta estimates over time along with their credible intervals to see if the trend was a suitable fit within the intervals, but considering the extremeness of the predictions made by our model with respect to the electoral college, the relationship between out point estimates and their credible intervals had no meaningful interpretations in terms of sensitivity analysis.
...
Sensitivity analysis was again conducted by changing the prior for $\mu_0$ in the model. We tried increasing and decreasing the variance of $\mu_0$, but had almost no impact on our prediction. We still got estimated probabilities of less than 1%. 
