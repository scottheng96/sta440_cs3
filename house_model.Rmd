...
M2 <- lmer(Trump.percentage ~ frac_coll_plus2010 + poor_share2010 + rent_twobed2015 + ann_avg_job_growth_2004_2013 + share_white2010 + share_black2010 + share_hisp2010 + share_asian2010 +  (1|county), data = full_counties, control = lmerControl(optimizer ="Nelder_Mead"))
summary(M2)
coef(M2)
