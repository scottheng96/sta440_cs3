...
w33 = ifelse(b33r > 50, 1, 0)
w34 = ifelse(b34r > 50, 1, 0)
w35 = ifelse(b35r > 50, 1, 0)
w36 = ifelse(b36r > 50, 1, 0)
w37 = ifelse(b37r > 50, 1, 0)
w38 = ifelse(b38r > 50, 1, 0)
w39 = ifelse(b39r > 50, 1, 0)
w40 = ifelse(b40r > 50, 1, 0)
w41 = ifelse(b41r > 50, 1, 0)
w42 = ifelse(b42r > 50, 1, 0)
w43 = ifelse(b43r > 50, 1, 0)
w44 = ifelse(b44r > 50, 1, 0)
w45 = ifelse(b45r > 50, 1, 0)
w46 = ifelse(b46r > 50, 1, 0)
w47 = ifelse(b47r > 50, 1, 0)
w48 = ifelse(b48r > 50, 1, 0)
w49 = ifelse(b49r > 50, 1, 0)
w50 = ifelse(b50r > 50, 1, 0)
w51 = ifelse(b51r > 50, 1, 0)
...
```{r}
r_matrix <- as.matrix(r_wins)
r_matrix %*% elec_votes_r
```