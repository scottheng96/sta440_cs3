...
jags_sims_trump <- jags(data = jags_data_trump,
                  ...
                  parameters.to.save = c("beta[1,1]",
                                                                          ...
                                                                          "beta[49,1]",
                                                                          "beta[50,1]",
                                                                          "beta[51,1]","beta[52,1]","beta[53,1]","beta[54,1]","beta[55,1]","beta[56,1]","sigma2_beta","p","sigma2_y"),
                  n.iter = 1000)
...
w52 = ifelse(b52r > 50, 1, 0)
w53 = ifelse(b53r > 50, 1, 0)
w54 = ifelse(b54r > 50, 1, 0)
w55 = ifelse(b55r > 50, 1, 0)
w56 = ifelse(b56r > 50, 1, 0)
