...
polls_republican <- polls_republican %>%
  filter(state != "Delaware" & state != "Oregon" & state != "Illinois" & state != "Idaho" & state != "Nebraska" & state != "West Virginia" & state != "Wyoming")
```
...
b22r <- jags_r$BUGSoutput$sims.array[21001:22500]
b23r <- jags_r$BUGSoutput$sims.array[22501:24000]
b3r <- jags_r$BUGSoutput$sims.array[24001:25500]
b4r <- jags_r$BUGSoutput$sims.array[25501:27000]
b5r <- jags_r$BUGSoutput$sims.array[27001:28500]
b6r <- jags_r$BUGSoutput$sims.array[28501:30000]
b7r <- jags_r$BUGSoutput$sims.array[30001:31500]
b8r <- jags_r$BUGSoutput$sims.array[31501:33000]
b9r <- jags_r$BUGSoutput$sims.array[33001:34500]
...
w22 = ifelse(b22r > 50, 1, 0)
w23 = ifelse(b23r > 50, 1, 0)
w24 = ifelse(b1r > 50, 1, 0)

r_wins <- data.frame(cbind(w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, w19, w20, w21, w22, w23, w24))
...
#missing a few states, but these races aren't predicted to be close
#RHODE ISLAND(D), Delaware(D), Oregon(D), Illinois(D)
#SOUTH DAKOTA(R) #LOUISIANA(R) # ARKANSAS(R), Idaho(R), Nebraska(R), West Virginia(R), Wyoming(R)
#double Georgia
#=
# R + 7, need 21 total for split
#14
...
w29 = ifelse(b29r > 50, 1, 0)
w30 = ifelse(b30r > 50, 1, 0)
w31 = ifelse(b31r > 50, 1, 0)
w32 = ifelse(b32r > 50, 1, 0)
#w33 = ifelse(b33r > b33d, 1, 0)
#w34 = ifelse(b34r > b34d, 1, 0)
