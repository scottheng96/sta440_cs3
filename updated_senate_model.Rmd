...
jags_r <- jags(data = jags_data_republican,
                  ...
                  parameters.to.save = c("beta[1,1]", "beta[2,1]", "beta[3,1]", "beta[4,1]", "beta[5,1]", 
                                         ...
                                         "beta[26,1]", "beta[27,1]", "beta[28,1]", "beta[29,1]"),
                  n.iter = 1000)
...
b4r <- jags_r$BUGSoutput$sims.array[34501:36000]
b5r <- jags_r$BUGSoutput$sims.array[36001:37500]
b6r <- jags_r$BUGSoutput$sims.array[37501:39000]
b7r <- jags_r$BUGSoutput$sims.array[39001:40500]
b8r <- jags_r$BUGSoutput$sims.array[40501:42000]
b9r <- jags_r$BUGSoutput$sims.array[42001:43500]
...
b4d <- jags_d$BUGSoutput$sims.array[34501:36000]
b5d <- jags_d$BUGSoutput$sims.array[36001:37500]
b6d <- jags_d$BUGSoutput$sims.array[37501:39000]
b7d <- jags_d$BUGSoutput$sims.array[39001:40500]
b8d <- jags_d$BUGSoutput$sims.array[40501:42000]
b9d <- jags_d$BUGSoutput$sims.array[42001:43500]
...
#ARKANSAS(R) #RHODE ISLAND(D) #SOUTH DAKOTA(R) #WEST VIRGINIA(R) #WYOMING(R) #LOUISIANA(R)
# double Georgia
# R + 5, need 21 total for split
#16
